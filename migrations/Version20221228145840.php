 ...
 */
final class Version20221228145840 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE tricks CHANGE created_at created_at VARCHAR(255) DEFAULT \'CURRENT_TIMESTAMP\' NOT NULL, CHANGE updated_at updated_at VARCHAR(255) DEFAULT NULL');
    }
}
